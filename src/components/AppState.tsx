...
export interface CartItem { name: string; price: number; id: number; quantity: number }
...
export const useDispatch = () => {
    ...
    if (!dispatch) {
        throw new Error('useDispatch was called oustide de AppDispatchContext provider')
    }
    return dispatch
}
